...
public class GraphRenderer {
	...
	public GraphRenderer(int width, int height,Collection<MapNode> nodes) {
		this(width,height,nodes,1);
	}
	
	public GraphRenderer(int width, int height,Collection<MapNode> nodes,double resizeFactor) {
		this.width = width;
		this.height = height;
	...
	public int getGraphWidth() {
		if (image != null)
			...
			return (int) (width * this.resizeFactor);
	}
	...
	public int getGraphHeight() {
		if (image != null)
			...
			return (int) (height * this.resizeFactor);
	}
